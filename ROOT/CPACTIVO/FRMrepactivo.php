...
?>
	...
	<body class="">
				...
				<div class="content">
					<div class="row">
						<div class="col-md-12">
									...
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<ul id="tabs" class="nav nav-tabs" role="tablist">
												...
												<li class="nav-item">
													<a class="nav-link active" href="../CPACTIVO/FRMrepactivo.php">
							...
							<div class="card demo-icons">
								<div class="card-header">
									<h5 class="card-title"><i class="fa fa-print"></i> Reportes de Activos</h5>
								</div>
								<div class="card-body all-icons">
									<form name="f1" id="f1" method="get">
										...
										<div class="row">
											<div class="col-md-12 text-center">
												<a type="button" class="btn btn-white" href="FRMrepactivo.php"><i class="fa fa-eraser"></i> Limpiar</a>
		...
		<?php echo modal("../"); ?>
		<?php echo scripts("../"); ?>
		<script type="text/javascript" src="../assets.1.2.7/js/modules/ppm/activo.js"></script>
		<script>
