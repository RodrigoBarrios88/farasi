...
<body class="">
					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-building-o"></i> Gestor de &Aacute;reas</h5>
							</div>
							<div class="card-body all-icons">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<?php echo sedes_html("sede", "comboSector(this.value);", "select2"); ?>
									</div>
									<div class="col-md-6">
										<label>Sector:</label> <span class="text-danger">*</span>
										<div id="divsector">
											<?php echo combos_vacios("sector", 'select2'); ?>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<label>Nombre del &Aacute;rea:</label> <span class="text-danger">*</span>
										<input type="text" class="form-control" name="nombre" id="nombre" onkeyup="texto(this)" />
										<input type="hidden" name="codigo" id="codigo" />
									</div>
									<div class="col-md-6">
										<label>Piso o Nivel:</label> <span class="text-danger">*</span>
										<input type="text" class="form-control" name="nivel" id="nivel" onkeyup="texto(this)" />
									</div>
								</div>
								<br>
								<div class="row">
	...
	<?php echo modal("../"); ?>
	<?php echo scripts("../"); ?>
	<script type="text/javascript" src="../assets.1.2.8/js/modules/sedes/area.js"></script>
	<script>
