					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fas fa-file-contract"></i> Generaci&oacute;n de Acta de Auditor&iacute;a</h5>
							</div>
							<div class="card-body all-icons">
								...
								<div class="row">
									<div class="col-lg-12" id="result">
										<?php
										echo tabla_auditorias($codigo, $auditoria, $usuario, $sede, $departamento, $categoria, $desde, $hasta);
										?>
									</div>
								</div>
								<br>
