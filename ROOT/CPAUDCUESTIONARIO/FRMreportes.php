						...
						<div class="col-md-12">
									...
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<ul id="tabs" class="nav nav-tabs" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" href="../CPAUDCUESTIONARIO/FRMreportes.php">
							...
							<div class="card demo-icons">
								<div class="card-header">
									<h5 class="card-title"><i class="fa fa-print"></i> Reportes de Programaci&oacute;n de Auditoria</h5>
								</div>
								<div class="card-body all-icons">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<select class="dual_select" id="columnas" name="columnas[]" multiple style="min-height: 250px;">
													...
													<option value="pro_situacion" selected>Situaci&oacute;n (Status)</option>
