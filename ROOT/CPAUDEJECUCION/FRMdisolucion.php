					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fab fa-buromobelexperte"></i> Disoluci&oacute;n de Hallazgos</h5>
							</div>
							<div class="card-body all-icons">
								<form name="f1" id="f1" action="" method="get">
									...
									<div class="row">
										<div class="col-md-12 text-center">
											<br>
											<a class="btn btn-white" href="FRMdisolucion.php"><i class="fa fa-eraser"></i> Limpiar</a>
								...
								<div class="row">
									<div class="col-lg-12" id="result">
										<?php
										echo tabla_disolucion($codigo, $auditoria, $usuario, $sede, $departamento, $categoria, $desde, $hasta);
										?>
									</div>
								</div>
								<br>
