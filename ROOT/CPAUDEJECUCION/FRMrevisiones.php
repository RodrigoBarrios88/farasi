					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="nc-icon nc-paper"></i> Historial de Auditor&iacute;as y Resultados</h5>
							</div>
							<div class="card-body all-icons">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<select class="form-control select2" id="situacion" name="situacion" onchange="Submit();">
												...
												<option value="3">Solicitando Aprobaci&oacute;n</option>
												<option value="4">Aprobado</option>
												<option value="5">Debe Corregir</option>
											</select>
											<script>
								...
								<div class="row">
									<div class="col-lg-12" id="result">
										<?php
										echo tabla_ejecucion($codigo, $auditoria, $usuario, $sede, $departamento, $categoria, $fini, $ffin, $situacion);
										?>
									</div>
								</div>
								<br>
