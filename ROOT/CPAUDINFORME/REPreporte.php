...
$id = $_SESSION["codigo"];
	...
	$pdf->MultiCell(0, 5, 'REPORTE DE CUMPLIMIENTO DE PLANES DE ACCI�N', 0 , 'L' , 0);
   ...
   $pdf->SetTextColor(0);  // AQUI LE DOY COLOR AL TEXTO
	...
	////////////////////////////////////// CUERPO ///////////////////////////////////////////
	$pdf->SetWidths($anchos);  // AQU� LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
	$pdf->SetAligns($alineaciones);  // AQU� LE DOY ANDHO A CADA UNA DE LAS COLUMNA$ClsPla = new ClsPlan();
	$result = $ClsPla->get_plan_solucion('','','',$sede,$departamento,$categoria,$fini,$ffin,$status,$situacion);$i=1;
	if(is_array($result)){
