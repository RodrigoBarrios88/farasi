					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fas fa-clipboard-check"></i> Generaci&oacute;n de Informes Finales</h5>
							</div>
							<div class="card-body all-icons">
								...
								<div class="row">
									<div class="col-lg-12" id="result">
										<?php
										echo tabla_ejecuciones_aprobadas($codigo, $auditoria, $usuario, $sede, $departamento, $categoria, $fini, $ffin);
										?>
									</div>
								</div>
								<br>
