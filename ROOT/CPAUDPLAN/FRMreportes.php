									...
									<div class="row">
										<div class="col-md-12">
											...
											<select class="dual_select" id="columnas" name="columnas[]" multiple style="min-height: 250px;">
												...
												<option value="audit_ponderacion">Ponderaci&oacute;n del Cuestionario</option>
												<option value="pro_codigo">C&oacute;digo de Programaci&oacute;n</option>
												<option value="pro_fecha">Fecha Programada</option>
												<option value="pro_hora">Hora Programada</option>
												<option value="pro_observaciones">Observaciones del Cuestionario</option>
												...
												<option value="eje_situacion">Situaci&oacute;n (Status)</option>
