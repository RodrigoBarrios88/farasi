...
$objPHPExcel->setActiveSheetIndex(0);    /// Combinacion de Celdas (Merge cells)
   ...
   ////// ENCABEZADOS /////
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('C8', "Nota Promedio");
    $objPHPExcel->getActiveSheet()->setCellValue('D8', "Cantidad de Auditorias");
    $objPHPExcel->getActiveSheet()->setCellValue('E8', "Ponderacion");
    //--
    ...
    /////////////////////////////
	 /////////////////////////////        
	$linea_inicial = 8;
   $linea = 9;$ClsEje = new ClsEjecucion();
	$dia_inicio = "";
	$CANT = 0;
	$SUMA = 0;
	$PROMEDIO = 0;
	if($periodo == "D"){
		...
		for($i = $fechaInicio; $i <= $fechaFin; $i+=86400){
			...
			$objPHPExcel->getActiveSheet()->setCellValue("C$linea", $promedio);
			$objPHPExcel->getActiveSheet()->setCellValue("D$linea", $cant);
			$objPHPExcel->getActiveSheet()->setCellValue("E$linea", $tipo);
	...
	$objPHPExcel->getActiveSheet()->setCellValue("C$linea", $PROMEDIO);
	$objPHPExcel->getActiveSheet()->setCellValue("D$linea", $CANT);
	$objPHPExcel->getActiveSheet()->setCellValue("E$linea", "-");
	$objPHPExcel->getActiveSheet()->getStyle("C$linea")->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER);
	$objPHPExcel->getActiveSheet()->getStyle("D$linea")->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER);
	//--
