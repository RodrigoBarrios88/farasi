						...
						<div class="card card-lock text-center">
							<form name = "f1" id = "f1" method = "post" >
								<div class="card-header ">
									<img src="../../CONFIG/img/icon.png" class="round-logo" alt="...">
								</div>
								<div class="card-body">
									<h4 class="card-title">Recuperaci&oacute;n de Contrase&ntilde;a</h4>
								...
								<div class="card-footer ">
									<button type="button" id="btn-enviar" onclick = "aceptar();" class="btn btn-primary btn-lg btn-round"><i class="fa fa-send"></i> Enviar</button>
								</div>
								<br>
							</form>
						</div>
