...
<body class="">
					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-tags"></i> Gestor de Categor&iacute;as para Audit Active</h5>
							</div>
	...
	<?php echo modal("../"); ?>
	<?php echo scripts("../"); ?>
	<script type="text/javascript" src="../assets.1.2.8/js/modules/auditoria/categoria.js"></script>
</body>
</html>