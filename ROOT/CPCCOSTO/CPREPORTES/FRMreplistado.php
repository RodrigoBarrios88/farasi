            ...
            <ul class="nav metismenu font-10" id="side-menu">
                ...
                <li class="active">
					...
					<ul class="nav nav-second-level">
						<li>
							<a href="../FRMnorma.php">
							<i class="fa fa-building-o"></i> Gestor de Centros de Costos
							</a>
						</li>
						<li class="active">
							<a href="FRMreplistado.php">
							<i class="fa fa-print"></i> Reporte de Centros de Costos
							</a>
						</li>
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content">
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-print"></i> &nbsp; Reporte de Centros de Costos</div>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                dom: '<"html5buttons"B>lTfgitp',
                 buttons: [
                    {extend: 'copy'},
                    {extend: 'csv', title: 'Reporte de Centros de Costos'},
                    {extend: 'excel', title: 'Reporte de Centros de Costos'},
                    ...
                    {extend: 'print',
						...
						title: 'Reporte de Centros de Costos'
                    }
                ]
            });
		});
