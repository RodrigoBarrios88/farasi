...
<body class="">
					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fab fa-creative-commons"></i> &nbsp; Gestor de Centros de Costos</h5>
							</div>
							<div class="card-body all-icons">
								...
								<div class="row">
									<div class="col-md-12">
										<label>Nombre del Centro de Costo:</label> <span class="text-danger">*</span>
	...
	<?php echo modal("../"); ?>
	<?php echo scripts("../"); ?>
	<script type="text/javascript" src="../assets.1.2.8/js/modules/master/centro_costo.js"></script>
</body>
</html>