					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-check-square-o"></i> Gestor de Check List</h5>
							</div>
							<div class="card-body all-icons">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div id="divsector">
											<?php echo utf8_decode(categorias_chk_html_usuarios_categorias("categoria", "", "select2")); ?>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-3 text-center">
										<label>&iquest;Requiere Fotos?:</label><br>
										<input class="form-check-input" type="checkbox" id="foto" name="foto" />
									</div>
									<div class="col-md-3 text-center">
										<label>&iquest;Requiere Firma?:</label><br>
										<input class="form-check-input" type="checkbox" id="firma" name="firma" />
									</div>
								</div>
								<br>
								<div class="row">
