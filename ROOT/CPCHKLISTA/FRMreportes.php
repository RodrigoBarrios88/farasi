						...
						<div class="col-md-12">
									...
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<ul id="tabs" class="nav nav-tabs" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" href="../CPCHKLISTA/FRMreportes.php">
							...
							<div class="card demo-icons">
								<div class="card-header">
									<h5 class="card-title"><i class="fa fa-print"></i> Reportes de Listas de Chequeo</h5>
								</div>
								<div class="card-body all-icons">
									<form name="f1" id="f1" method="get">
										...
										<div class="row">
											<div class="col-md-6">
												<label>D&iacute;a Programado:</label> <span class="text-success">*</span>
												<select id="dia" name="dia" class="form-control select2">
													<option value="" selected>Cualquier d&iacute;a</option>
