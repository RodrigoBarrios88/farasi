								...
								<div class="nav-tabs-navigation">
									<div class="nav-tabs-wrapper">
										<ul id="tabs" class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link active" href="../CPCHKREVISION/FRMreportes.php" >
													<h6><i class="fa fa-print"></i> Revisiones</h6>
												</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="../CPCHKREVISION/FRMresultados.php" >
								...
								<div class="row">
									<div class="col-md-12">
										...
										<select class="dual_select"  id = "columnas" name="columnas[]" multiple style="min-height: 250px;" >
											<option value="rev_codigo">C&oacute;digo de Revisi&oacute;n</option>
											...
											<option value="pro_dias" selected>D&iacute;as Programados</option>
											<option value="pro_hini_hfin" selected>Intervalo de Horarios</option>
											<option value="pro_tipo" selected>Tipo de Programaci&oacute;n</option>
											<option value="pro_observaciones" selected>Observaciones de la Lista</option>
											...
											<option value="rev_firma" selected>Imagen Firma</option>
											<option value="rev_foto" selected>Foto (Revisi&oacute;n)</option>
											<option value="rev_cont_si" selected>Conteo de "SI"</option>
											<option value="rev_cont_no" selected>Conteo de "NO"</option>
											<option value="rev_cont_na" selected>Conteo de "NO APLICA"</option>
											<option value="rev_nota" selected>% de Cumplimiento (SI/NO)</option>
