...
<body class="sidebar-mini">
					...
					<div class="col-md-12">
								...
								<div class="nav-tabs-navigation">
									<div class="nav-tabs-wrapper">
										<ul id="tabs" class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link active" href="../CPCHKREVISION/FRMrespuestas.php" >
						...
						<div class="card demo-icons">
							...
							<div class="card-body all-icons">
								...
								<div class="row">
									<div class="col-md-6">
										<label>C&oacute;digo de Revisi&oacute;n:</label> <span class="text-success">*</span>
										<input type="text" class="form-control" name="revision" id="revision" value = "<?php echo $revision; ?>" />
									</div>
									<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-12 text-center">
										<a type="button" class="btn btn-white" href="FRMrespuestas.php"><i class="fa fa-eraser"></i> Limpiar</a>
	...
	<script>
		...
		function HTML(){
			...
			myform.action ="FRMrespuesta.php";
			myform.submit();
			myform.action ="";
			myform.target ="";
			myform.method = "get";
			...
			myform.method = "get";
			myform.target ="_blank";
			myform.action ="REPrespuesta.php";
			myform.submit();
			myform.action ="";
			myform.target ="";
			myform.method = "get";
		...
		function Excel(){
			...
			myform.method = "get";
			myform.target ="_blank";
			myform.action ="EXCELrespuesta.php";
			myform.submit();
			myform.action ="";
			myform.target ="";
			myform.method = "get";
