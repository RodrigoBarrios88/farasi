...
<body class="">
					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-building-o"></i> &nbsp; Gestor de Departamentos</h5>
							</div>
							<div class="card-body all-icons">
								...
								<div class="row">
									<div class="col-md-12">
										<label>Nombre del Departamento:</label> <span class="text-danger">*</span>
    ...
    <script type="text/javascript" src="../assets.1.2.8/js/modules/sedes/departamento.js"></script>  
</body>
</html>
