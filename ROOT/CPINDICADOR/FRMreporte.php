						...
						<div class="col-md-12">
							<div class="card demo-icons">
								<div class="card-header">
									<h5 class="card-title"><i class="fa fa-bar-chart-o"></i> Reportes de Programaciones</h5>
								</div>
								<div class="card-body all-icons">
									<div class="row">
										<div class="col-lg-12" id="result">
											<?php
											echo tabla_reportes($departamento, $clasificacion, $categoria, $situacion, $desde, $hasta, $columnas);
											?>
										</div>
									</div>
									<br>
