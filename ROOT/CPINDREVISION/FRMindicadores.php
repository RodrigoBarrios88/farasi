									...
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<ul id="tabs" class="nav nav-tabs" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" href="../CPINDICADOR/FRMindicadores.php">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<select class="dual_select" id="columnas" name="columnas[]" multiple style="min-height: 250px;">
													<option value="rev_codigo">C&oacute;digo de Ejecuci&oacute;n</option>
													...
													<option value="rev_observaciones" selected>Observaciones de la Ejecuci&oacute;n</option>
													<option value="rev_situacion">Situaci&oacute;n</option>
													<option value="rev_lectura" selected>Lectura Registrada</option>
													<option value="medida_nombre" selected>Unidad de medida</option>
													<option value="ind_codigo">C&oacute;digo de Indicador</option>
													...
													<option value="pro_observaciones" selected>Observaciones del indicador</option>
