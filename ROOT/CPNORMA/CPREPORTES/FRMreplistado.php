            ...
            <ul class="nav metismenu font-10" id="side-menu">
                ...
                <li class="active">
					...
					<ul class="nav nav-second-level">
						<li>
							<a href="../FRMnorma.php">
							<i class="fa fa-building-o"></i> Gestor de Normas
							</a>
						</li>
						<li class="active">
							<a href="FRMreplistado.php">
							<i class="fa fa-print"></i> Reporte de Normas
							</a>
						</li>
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content">
            <div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-print"></i> &nbsp; Reporte de Normas</div>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                dom: '<"html5buttons"B>lTfgitp',
                 buttons: [
                    {extend: 'copy'},
                    {extend: 'csv', title: 'Reporte de Normas'},
                    {extend: 'excel', title: 'Reporte de Normas'},
