...
<body class="">
					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-passport"></i> &nbsp; Gestor de Normas</h5>
							</div>
							<div class="card-body all-icons">
								...
								<div class="row">
									<div class="col-md-12">
										<label>Nombre del Norma:</label> <span class="text-danger">*</span>
	...
	<?php echo modal("../"); ?>
	<?php echo scripts("../"); ?>
	<script type="text/javascript" src="../assets.1.2.8/js/modules/master/norma.js"></script>
</body>
</html>