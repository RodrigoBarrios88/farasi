...
<body>
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
									<a href="FRMreppermiso.php"><i class="glyphicon glyphicon-briefcase"></i> Permisos<span class="glyphicon arrow"></span></a>
        ...
        <div id="page-wrapper">
			<form name = "f1" id = "f1" action="REPpermiso.php" method="post" target = "_blank">
            <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label class = "etiqueta"><i class="fa fa-print"></i> Reporte de Permisos</label></div>
                <div class="panel-body">
					<div class="row">
						<div class="col-xs-12 col-xs-12 text-right"> <label class = " text-info">* Campos de Busqueda</label></div>
					</div>
                    <div class="row">
                        <div class="col-xs-2 text-right"><label class = "etiqueta">Grupo: </label> <span class="text-info">*</span></div>
                        <div class="col-xs-4"><?php echo utf8_decode(grupos_html("gru")); ?><input type = "hidden" name = "cod" id = "cod" /></div>
                        <div class="col-xs-2 text-right"><label class = "etiqueta">Clave: </label> <span class="text-info">*</span></div>
                        <div class="col-xs-4 text-left"><input type = "text" class="form-control" name = "clv" id = "clv" onkeyup = "texto(this)" maxlength = "10" /></div>
                    </div>
                    <br>
                    <div class="row">
