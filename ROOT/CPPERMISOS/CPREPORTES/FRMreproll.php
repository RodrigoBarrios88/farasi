...
<body>
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
									<a href="FRMreproll.php"><i class="glyphicon glyphicon-briefcase"></i> Roles<span class="glyphicon arrow"></span></a>
									<ul class="nav nav-third-level collapse">
										<li>
        ...
        <div id="page-wrapper">
			<form name = "f1" id = "f1" action="REProll.php" method="post" target = "_blank">
            <br>
            <div class="panel panel-default">
				<div class="panel-heading"><label class = "etiqueta"><i class="fa fa-print"></i> Reporte de Roles de Permiso</label></div>
                <div class="panel-body">
					<div class="row">
						<div class="col-xs-12 col-xs-12 text-right"> <label class = " text-info">* Campos de Busqueda</label></div>
					</div>
                    <div class="row">
                        <div class="col-xs-3 text-right"><label class = "etiqueta">Nombre del Rol: <span class="text-info">*</span></div>
                        <div class="col-xs-3"><input type = "text" class="form-control" name = "nom" id = "nom" onkeyup = "texto(this)" /></div>
                        <div class="col-xs-2 text-right"><label class = "etiqueta">Descripci&oacute;n: <span class="text-info">*</span></div>
        ...
        <footer class="footer-login">
			<div>
				  ...
				  <p>
					Powered by Inversiones Digitales S.A. Web Development Team.
					Copyright &copy; 2017.
				  </p>
			</div>
		</footer>
    ...
    <script type="text/javascript" src="../../js.1.1.1/modules/seguridad/rol.js"></script>
