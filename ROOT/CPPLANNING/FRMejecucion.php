									...
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<ul id="tabs" class="nav nav-tabs" role="tablist">
												...
												<li class="nav-item">
													<a class="nav-link active" href="../CPPLANNING/FRMejecucion.php">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<select class="dual_select" id="columnas" name="columnas[]" multiple style="min-height: 250px;">
													<option value="eje_codigo" selected>C&oacute;digo de la Ejecuci&oacute;n</option>
													...
													<option value="eje_observacion" selected>Observaci&oacute;n</option>
		...
		<script>
			...
			function HTML() {
				...
				if (columnas >= 1) {
					...
					myform.action = "FRMreporte_ejecucion.php";
					myform.submit();
					myform.action = "";
					myform.target = "";
					myform.method = "get";
			...
			function Excel() {
				...
				if (columnas >= 1) {
					...
					myform.method = "get";
					myform.target = "_blank";
					myform.action = "EXCELreporte_ejecucion.php";
					myform.submit();
					myform.action = "";
					myform.target = "";
					myform.method = "get";
