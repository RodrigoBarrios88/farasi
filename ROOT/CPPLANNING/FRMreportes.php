									...
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<ul id="tabs" class="nav nav-tabs" role="tablist">
												<li class="nav-item">
													<a class="nav-link" href="../CPPLANNING/FRMaccion.php">
												...
												<li class="nav-item">
													<a class="nav-link active" href="../CPPLANNING/FRMreportes.php">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<select class="dual_select" id="columnas" name="columnas[]" multiple style="min-height: 250px;">
													<option value="eva_codigo" selected>C&oacute;digo de la Evaluaci&oacute;n</option>
													<option value="eva_usuario">Usuario que Eval&uacute;a</option>
													<option value="eva_fecha" selected>Fecha de Evaluaci&oacute;n</option>
													<option value="eva_observacion" selected>Observaci&oacute;n</option>
													<option value="eva_puntuacion" selected>Puntuaci&oacute;n</option>
													<option value="eje_fecha" selected>Fecha de Ejecuci&oacute;n</option>
													<option value="acc_usuario" selected>Usuario que Ejecuta</option>
													<option value="acc_descripcion" selected>Acci&oacute;n</option>
													<option value="acc_tipo" selected>Tipo</option>
													<option value="pro_fecha_inicio" selected>Programaci&oacute;n Fecha de Inicio</option>
													<option value="pro_fecha_fin" selected>Programaci&oacute;n Fecha Fin</option>
													<option value="pro_dia_inicio" selected>D&iacute;a Planificado</option>
													<option value="pro_dia_fin">&Uacute;ltimo D&iacute;a</option>
												</select>
											</div>
										</div>
										<br>
