...
<body class="sidebar-mini">
			...
			<?php echo navbar("../"); ?> <div class="content">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="card">
							<div class="card-header ">
								<h4 class="card-title"><i class="nc-icon nc-calendar-60"></i> Reporte de Objetivos</h4>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="card">
							...
							<!--ddd <div class="card-footer text-right">
									<hr>
									<div class="stats">
										<i class="fa fa-clock-o"></i> <?php echo $desde . ' - ' . $hasta; ?>
									</div>
	...
	<?php echo modal("../"); ?>
	<?php echo scripts("../"); ?>
	<script type="text/javascript" src="../assets.1.2.8/js/modules/planning/menu_usuario.js"></script>
	<script>
