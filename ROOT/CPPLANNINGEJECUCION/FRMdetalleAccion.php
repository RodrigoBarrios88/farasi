...
if (is_array($result)) {
	foreach ($result as $row) {
		...
		$objetivoCodigo = trim($row['obj_codigo']);
	}
}
...
$rs = $ClsEva->get_evaluacion("", "", "", "", "", $user, $objetivoCodigo);
	if (is_array($rs)) {
		foreach ($rs as $row) {
			...
			<?php echo navbar("../"); ?> <div class="content">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fas fa-pen-nib"></i> Evidencia</h5>
							</div>
							<div class="card-body all-icons">
								<div class="row">
									<div class="col-md-12 ml-auto mr-auto">
										<label for="" class="">Observaci&oacute;n</label>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fas fa-clipboard-list"></i> Puntuaci&oacute;n</h5>
							</div>
							<div class="card-body all-icons">
								<div class="row">
									<div class="col-md-12">
										<label>Puntaje:</label> <span class="text-danger">*</span>
										<textarea class="form-control textarea-autosize" name="observacion" id="observacion" onkeyup="textoLargo(this);" rows="5" disabled><?=$puntuacion?></textarea>
									</div>
								</div>
