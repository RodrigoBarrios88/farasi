...
$usuario = ($_REQUEST["usuario"] == "") ? $_SESSION["codigo"] : $_REQUEST["usuario"];
					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-users-cog"></i> Ejecuci&oacute;n de Ordenes de Trabajo Programadas</h5>
							</div>
							<div class="card-body all-icons">
								<form name="f1" id="f1" action="" method="get">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<label>Usuario Asignado:</label> <span class="text-info">*</span>
									...
									<div class="row">
										<div class="col-md-12 text-center">
											<a type="button" class="btn btn-white" id="btn-limpiar" href="FRMejecucion.php"><i class="fas fa-eraser"></i> Limpiar</a>
							...
							<div class="card-body all-icons">
								<div class="row">
									<div class="col-xs-12 col-md-12">
										<?php echo tabla_programacion($activo, $usuario, $categoria, '', $area, $desde, $hasta); ?>
									</div>
								</div>
							</div>
						</div>
