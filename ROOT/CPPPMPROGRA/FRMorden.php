				...
				<div class="row">
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title">
									<i class="nc-icon nc-pin-3"></i> Orden de Trabajo No. <?php echo Agrega_Ceros($codigo); ?>. <small>Fecha de Actualizaci&oacute;n <?php echo $fecha_update; ?></small>
								</h5>
							</div>
							<div class="card-body all-icons">
								<div class="row">
					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-body all-icons">
								<div class="row">
									<div class="col-md-12">
										<h5>Historial de Reprogramaciones:</h5>
										<?php echo tabla_reprogramaciones($codigo); ?>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-md-12">
										<h5>Historial de Reasignaciones:</h5>
										<?php echo tabla_reasignaciones($codigo); ?>
									</div>
								</div>
							</div>
						</div>
