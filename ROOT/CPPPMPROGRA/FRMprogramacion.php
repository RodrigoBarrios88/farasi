					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title">
									<i class="fa fa-users-cog"></i> Programaci&oacute;n de Ordenes de Trabajo
								...
								<form name="f1" id="f1" action="" method="get">
									...
									<div class="row">
										<div class="col-md-12 text-center">
											<a type="button" class="btn btn-white" id="btn-limpiar" href="FRMprogramacion.php"><i class="fas fa-eraser"></i> Limpiar</a>
