...
$hasta = ($hasta == "") ? "31/$mes/$anio" : $hasta; //valida que si no se selecciona fecha, coloque la del dia
?>
<!DOCTYPE html>
<html>
			...
			<div class="content">
				<div class="row">
					<div class="col-md-12">
								...
								<div class="nav-tabs-navigation">
									<div class="nav-tabs-wrapper">
										<ul id="tabs" class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link active" href="../CPPPMPROGRA/FRMreportes.php">
						...
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-file-excel-o"></i> Reporte de Programaci&oacute;n</h5>
							</div>
							<div class="card-body all-icons">
