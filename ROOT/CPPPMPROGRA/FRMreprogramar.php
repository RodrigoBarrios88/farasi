						...
						<div class="col-md-12">
							<div class="card demo-icons">
								<div class="card-header">
									<h5 class="card-title"><i class="fa fa-calendar-o"></i> Re-Programaci&oacute;n de Ordenes de Trabajo</h5>
								</div>
								<div class="card-body all-icons">
									<form name="f1" id="f1" action="" method="get">
										...
										<div class="row">
											<div class="col-md-6">
												<label>Fecha Anterior:</label> <span class="text-danger">*</span>
												<input type="text" class="form-control" name="fechaold" id="fechaold" value="<?php echo $fecha; ?>" disabled />
											</div>
											<div class="col-md-6">
												<label>Nueva Fecha a programar:</label> <span class="text-danger">*</span>
												<div class="form-group">
													<div class="input-group date">
														<input type="text" class="form-control" name="fechanew" id="fechanew" value="<?php echo $fecha; ?>">
										...
										<div class="row">
											<div class="col-md-12 text-center">
												...
												<button type="button" class="btn btn-primary" id="btn-grabar" onclick="reProgramar();"><i class="fas fa-save"></i> Re-Programar</button>
											</div>
										</div>
									</form>
									<br>
