					...
					<div class="col-md-12">
								...
								<div class="nav-tabs-navigation">
									<div class="nav-tabs-wrapper">
										<ul id="tabs" class="nav nav-tabs" role="tablist">
											<li class="nav-item">
												<a class="nav-link" href="../CPPROCESS/FRMsistemas.php">
													<h6><i class="fa fa-print"></i> Listado de Sistemas</h6>
												</a>
											</li>
											<li class="nav-item">
												<a class="nav-link active" href="../CPPROCESS/FRMclasificacion.php">
						...
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-print"></i> Reportes de Clasificaci&oacute;n de Recursos</h5>
							</div>
							<div class="card-body all-icons">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<select class="dual_select" id="columnas" name="columnas[]" multiple style="min-height: 250px;">
												<option value="rec_codigo" selected>C&oacute;digo</option>
												<option value="rec_proceso" selected>Proceso</option>
												<option value="rec_tipo_recurso">Tipo</option>
												<option value="rec_descripcion">Descripci&oacute;n</option>
												<option value="rec_usuario" selected>Usuario</option>
												<option value="rec_fecha_registro">Fecha de registro</option>
											</select>
										</div>
									</div>
									<br>
	...
	<script>
		...
		function HTML() {
			...
			if (columnas >= 1) {
				...
				myform.action = "FRMreporte_clasificacion.php";
				myform.submit();
				myform.action = "";
				myform.target = "";
				myform.method = "get";
		...
		function Excel() {
			...
			if (columnas >= 1) {
				...
				myform.method = "get";
				myform.target = "_blank";
				myform.action = "EXCELreporte_clasificacion.php";
				myform.submit();
				myform.action = "";
				myform.target = "";
				myform.method = "get";
