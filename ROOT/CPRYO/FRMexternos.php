					...
					<div class="col-md-12">
								...
								<div class="nav-tabs-navigation">
									<div class="nav-tabs-wrapper">
										<ul id="tabs" class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link active" href="../CPRYO/FRMexternos.php">
						...
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title">
									<i class="fa fa-search"></i> Identificaci&oacute;n de Riesgos Externos
								</h5>
							</div>
							<div class="card-body all-icons">
								<form name="f1" id="f1" action="" method="get">
									...
									<div class="row">
										<div class="col-lg-12" id="result">
											<?php echo tabla_foda_asignados($proceso, $sistema, $id, 4); ?>
										</div>
									</div>
								</form>
							</div>
