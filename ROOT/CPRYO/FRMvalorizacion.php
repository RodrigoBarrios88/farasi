					...
					<div class="col-md-12">
								...
								<div class="nav-tabs-navigation">
									<div class="nav-tabs-wrapper">
										<ul id="tabs" class="nav nav-tabs" role="tablist">
											<li class="nav-item">
												<a class="nav-link active" href="../CPRYO/FRMvalorizacion.php">
						...
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title">
									<i class="fa fa-balance-scale"></i> Valorizaci&oacute;n de Riesgos Internos
								</h5>
							</div>
							<div class="card-body all-icons">
								<div class="row">
								...
								<div class="row">
									<div class="col-lg-12" id="result">
										<?php echo tabla_valorizacion($proceso, $sistema, 3,$id); ?>
									</div>
								</div>
							</div>
						</div>
