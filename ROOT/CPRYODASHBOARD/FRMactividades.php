								...
								<div class="nav-tabs-navigation">
									<div class="nav-tabs-wrapper">
										<ul id="tabs" class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link active" href="../CPRYODASHBOARD/FRMactividades.php">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<select name="tipo" id="tipo" class="form-control select2" onchange="Submit()">
												...
												<option value="1">Actividad de Acci&oacute;n</option>
												<option value="2">Actividad Inmediata</option>
											</select>
											<script>
									...
									<div class="row">
										<div class="col-md-12">
											...
											<select class="dual_select" id="columnas" name="columnas[]" multiple style="min-height: 250px;">
												...
												<option value="act_tipo" selected>Tipo de Actividad</option>
