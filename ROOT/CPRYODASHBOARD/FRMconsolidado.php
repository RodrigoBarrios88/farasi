...
<body class="sidebar-mini">
					...
					<div class="col-lg-12" id="result">
						<div class="card">
							<div class="card-header ">
								<h4 class="card-title"><i class="nc-icon nc-chart-pie-36"></i> Consolidado de Riesgos y Oportunidades</h4>
							</div>
							<div class="card-body ">
								<div class="row">
									<div class="col-lg-12" id="result">
										<?php echo utf8_decode(tabla_cumplimiento("", $proceso, $sistema, $usuario)); ?>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="card">
							...
							<div class="card-body" id="tablaContainer">
								<?php echo utf8_decode(tabla_programacion("")) ?>
							</div>
							<div class="card-footer text-right">
								<hr>
								<div class="stats">
	...
	<?php echo modal("../"); ?>
	<?php echo scripts("../"); ?>
	<script type="text/javascript" src="../assets.1.2.8/js/modules/ryo/consolidado.js"></script>
</body>
