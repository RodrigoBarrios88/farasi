					...
					<div class="col-md-12">
								...
								<div class="nav-tabs-navigation">
									<div class="nav-tabs-wrapper">
										<ul id="tabs" class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link active" href="../CPRYODASHBOARD/FRMplanes.php">
													<h6><i class="fa fa-print"></i> Planes </h6>
												</a>
											</li>
						...
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-print"></i> Reportes de Planes</h5>
							</div>
							<div class="card-body all-icons">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<select class="dual_select" id="columnas" name="columnas[]" multiple style="min-height: 250px;">
												<option value="pla_codigo" selected>C&oacute;digo del Plan</option>
												<option value="fod_descripcion" selected>Riesgo/Oportunidad</option>
												<option value="fic_nombre" selected>Proceso</option>
												<option value="fod_sistema" selected>Sistema</option>
												<option value="usu_nombre" selected>Responsable</option>
												<option value="pla_fecha_creacion" selected>Fecha de Creaci&oacute;n</option>
												<option value="usu_revisa">Usuario que Revisa</option>
	...
	<script>
		...
		function HTML() {
			...
			if (columnas >= 1) {
				...
				myform.action = "FRMreporte_planes.php";
				myform.submit();
				myform.action = "";
				myform.target = "";
				myform.method = "get";
