					...
					<div class="col-md-12">
								...
								<div class="nav-tabs-navigation">
									<div class="nav-tabs-wrapper">
										<ul id="tabs" class="nav nav-tabs" role="tablist">
											<li class="nav-item">
												<a class="nav-link active" href="../CPRYODASHBOARD/FRMreportes.php">
													<h6><i class="fa fa-print"></i> Riesgos</h6>
												</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="../CPRYODASHBOARD/FRMoportunidades.php">
						...
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-print"></i> Reporte de Riesgos</h5>
							</div>
							<div class="card-body all-icons">
								<form name="f1" id="f1" method="get">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<label>Tipo:</label> <span class="text-info">*</span>
											<select name="tipo" id="tipo" class="form-control select2" onchange="Submit()">
												<option value="">Seleccione</option>
												<option value="3">Riesgo Interno</option>
												<option value="4">Riesgo Externo</option>
											</select>
											<script>
									...
									<div class="row">
										<div class="col-md-12">
											...
											<select class="dual_select" id="columnas" name="columnas[]" multiple style="min-height: 250px;">
												<option value="rie_codigo" selected>C&oacute;digo del Riesgo</option>
												<option value="fod_descripcion" selected>Riesgo</option>
												<option value="fod_tipo" selected>Tipo</option>
												<option value="fic_nombre" selected>Proceso</option>
												<option value="fod_sistema" selected>Sistema</option>
												<option value="rie_origen" selected>Origen</option>
												<option value="rie_causa" selected>Causa</option>
												<option value="rie_consecuencia" selected>Consecuencia</option>
												<option value="rie_probabilidad" selected>Probabilidad</option>
												<option value="rie_impacto" selected>Impacto</option>
												<option value="rie_severidad" selected>Severidad</option>
												<option value="rie_condicion" selected>Condici&oacute;n</option>
												<option value="rie_usuario" selected>Usuario que Identifica</option>
												<option value="rie_fecha_registro" selected>Fecha de Identificaci&oacute;n</option>
												<option value="rie_evaluacion_tipo" selected>Evaluaci&oacute;n/Reevaluaci&oacute;n</option>
												<option value="rie_accion" selected>Acci&oacute;n</option>
											</select>
										</div>
									</div>
									<br>
