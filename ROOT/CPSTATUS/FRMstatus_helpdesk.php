...
<body class="">
					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-tags"></i> Gestor de Status para Problem Sweeper</h5>
							</div>
	...
	<script type="text/javascript" src="../assets.1.2.8/js/modules/helpdesk/status.js"></script>
</body>
