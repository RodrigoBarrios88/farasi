					...
					<div class="col-md-12">
						...
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-print"></i> Reportes de Tickets</h5>
							</div>
							<div class="card-body all-icons">
								...
								<div class="row">
									<div class="col-md-6">
										<label>Incidente:</label> <span class="text-success">*</span>
									...
									<div class="col-md-6">
										<label>Prioridad:</label> <span class="text-success">*</span>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<select class="dual_select"  id = "columnas" name="columnas[]" multiple style="min-height: 250px;" >
											<option value="tic_codigo" selected>N&uacute;mero de Ticket</option>
											<option value="tic_fecha_registro" selected>Fecha y hora de Inicio</option>
											<option value="tic_fecha_fin" selected>Fecha y hora de Finalizaci&oacute;n</option>
											<option value="tic_imagenes">Imagenes por Status</option>
											<option value="inc_codigo">C&oacute;digo de Incidente</option>
											<option value="inc_nombre" selected>Incidente</option>
											<option value="sta_codigo">C&oacute;digo de Status</option>
											<option value="sta_nombre" selected>Status</option>
											<option value="sta_color">Color (Status)</option>
											<option value="tic_status_observaciones" selected>Observaciones del &Uacute;ltimo Status</option>
											<option value="pri_codigo">C&oacute;digo de Prioridad</option>
											<option value="pri_nombre" selected>Prioridad</option>
											<option value="pri_respuesta" selected>Tiempo de Respuesta Planificado</option>
											<option value="pri_solucion" selected>Tiempo de Soluci&oacute;n Planificado</option>
											
											<option value="tic_respuesta" selected>Tiempo de Respuesta Efectivo</option>
											<option value="tic_solucion" selected>Tiempo de Soluci&oacute;n Efectivo</option>
											<option value="tic_espera" selected>Tiempo en espera o Hold On</option>
											
											<option value="pri_recordatorio">Recordatorio</option>
											<option value="pri_color">Color (Prioridad)</option>
											<option value="cat_codigo">C&oacute;digo de Categor&iacute;a</option>
											<option value="cat_nombre" selected>Categor&iacute;a</option>
											<option value="cat_color">Color (Categor&iacute;a)</option>
											<option value="tic_descripcion" selected>Descripci&oacute;n del Incidente</option>
											...
											<option value="usuario_registro" selected>Usuario que Registra</option>
										</select>
