					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-link"></i> Asignaci&oacute;n de Usuarios a Categor&iacute;as de Indicadores</h5>
							</div>
							<div class="card-body all-icons">
								<form id="f1" action="FRMusuario_categoria_indicador.php" method="get">
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-md-6 text-center">
											<span>&nbsp;</span>
											<a type="button" href="FRMusuario_categoria_indicador.php" class="btn btn-block btn-lg btn-primary"><span class="fa fa-refresh"></span></a>
										</div>
									</div>
									<br>
								</form>
								...
								<form id="form" action="#" class="wizard-big">
									<div class="row">
										<div class="col-lg-12">
											<?php
											////////---------- Obtiene las categorias asignadas a cada usuario
											if ($usuario != "") {

												$ClsUsu = new ClsUsuario();
												$result = $ClsUsu->get_usuario_categoria_indicador("", $usuario, "");
												//echo $result;
												if (is_array($result)) {
													$arrcategorias = array();
													$categorias_asignadas = 0;
													foreach ($result as $row) {
														$arrcategorias[$categorias_asignadas] = $row["ius_indicador"];
	...
	<script>
		$(document).ready(function() {
			...
			$("#form").submit(function() {
				asignarCategoriasIndicadores($('[name="duallistbox1[]"]').val());
				return false;
			});
