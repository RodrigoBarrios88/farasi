					...
					<div class="col-md-12">
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-check-square-o"></i> Gestor de Cuestionarios para Encuestas</h5>
							</div>
							<div class="card-body all-icons">
								...
								<div class="row">
									<div class="col-md-12">
										<label>Descripci&oacute;n de la Encuesta:</label> <span class="text-muted">(opcional)</span>
										<textarea class="form-control" name="descripcion" id="descripcion" rows="2" onkeyup="textoLargo(this);"></textarea>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<label>Objetivo:</label> <span class="text-muted">(opcional)</span>
										<textarea class="form-control" name="objetivo" id="objetivo" rows="2" onkeyup="textoLargo(this);"></textarea>
									</div>
								</div>
								<br>
								<div class="row">
