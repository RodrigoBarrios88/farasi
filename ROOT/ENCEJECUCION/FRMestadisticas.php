											...
											if (is_array($result)) {
												...
												foreach ($result as $row) {
													...
													if ($pregunta_tipo == 1) {
														...
														$r9 = ($r9 == "") ? 0 : $r9;
														$r10 = ($r10 == "") ? 0 : $r10;
														$json .= '{y: "Valor1", x: "' . $r1 . '"},{y: "Valor2", x: "' . $r2 . '"},{y: "Valor3", x: "' . $r3 . '"},{y: "Valor4", x: "' . $r4 . '"},{y: "Valor5", x: "' . $r5 . '"},{y: "Valor6", x: "' . $r6 . '"},{y: "Valor7", x: "' . $r7 . '"},{y: "Valor8", x: "' . $r8 . '"},{y: "Valor9", x: "' . $r9 . '"},{y: "Valor10", x: "' . $r10 . '"}';
													} else if ($pregunta_tipo == 2) {
														$r1 = ($r1 == "") ? 0 : $r1;
														$r5 = ($r5 == "") ? 0 : $r5;
														$json .= '{y: "SI", x: "' . $r1 . '"},{y: "NO", x: "' . $r2 . '"}';
													}
													$salida_js .= "Morris.Bar({ ";
													$salida_js .= "element: 'chart$x',";
											...
											?>
													...
													<div class="row">
														<div class="col-md-6 text-center">
															...
															<div id="chart<?php echo $x; ?>"></div>
														</div>
														<div class="col-md-6 text-center">
															<label>&Uacute;ltimo Comentario</label>
															<table class="table table-striped table-bordered table-hover">
															<?php if ($observacion != "") : ?>
																<td class="text-justify"><?php echo $observacion; ?></td>
															<?php else:?>
																<p class="text-danger text-center">A&uacute;n no se ha comentado esta pregunta</p>
															<?php endif?>
															</table>
															<br>
								
															<?php if ($observacion != "") : ?>
																<button type="button" button class="btn btn-dark btn-lg" onclick="mostrarComentarios(<?php echo $pregunta_codigo; ?>)"><small><i class="fas fa-comments"></i> Ver Comentarios</small></button>
															<?php endif; ?>
														</div>
