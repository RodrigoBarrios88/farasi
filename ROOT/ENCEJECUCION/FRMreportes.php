					...
					<div class="col-md-12">
									...
									<div class="nav-tabs-wrapper">
										<ul id="tabs" class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item active">
												<a class="nav-link active" href="../ENCEJECUCION/FRMreportes.php">
						...
						<div class="card demo-icons">
							<div class="card-header">
								<h5 class="card-title"><i class="fa fa-print"></i> Reportes de Encuestas resueltas o pendientes de resolver</h5>
							</div>
							<div class="card-body all-icons">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<select class="dual_select" id="columnas" name="columnas[]" multiple style="min-height: 250px;">
												<option value="cue_codigo">C&oacute;digo de Cuestionario</option>
												...
												<option value="eje_fecha_inicio">Fecha de Inicio</option>
												<option value="eje_fecha_final">Fecha de Finalizaci&oacute;n</option>
												<option value="eje_respondio" selected>Responde Encuesta</option>
												<option value="eje_correo" selected>Correo de Qui&eacute;n Responde</option>
												<option value="eje_telefono">Tel&eacute;fono de Qui&eacute;n Responde</option>
												<option value="eje_observaciones">Observaciones</option>
