<?php
    ...
    function write_visita (){
        ...
        if (!$_GET) {
            ...
            $location = array(
                "ip" => ip_info($new_ip, "ip"),
                "pais" => ip_info($new_ip, "Country"),
                "region" => ip_info($new_ip, "region"),
                "ciudad" => ip_info($new_ip, "city")
            );
    ...
    function ip_info($ip = NULL, $purpose = "location", $deep_detect = TRUE) {
        ...
        $support    = array("ip", "country", "countrycode", "state", "region", "city", "location", "address");
        $continents = array(
            "AF" => "Africa",
            "AN" => "Antarctica",
            "AS" => "Asia",
