...
$id = $_SESSION["codigo"];
   ...
   $pdf->SetTextColor(0);  // AQUI LE DOY COLOR AL TEXTO
	...
	////////////////////////////////////// CUERPO ///////////////////////////////////////////
	$pdf->SetWidths($anchos);  // AQU� LE DOY ANDHO A CADA UNA DE LAS COLUMNAS;
	$pdf->SetAligns($alineaciones);  // AQU� LE DOY ANDHO A CADA UNA DE LAS COLUMNA$ClsRes = new ClsEncuestaResolucion();
	$result = $ClsRes->get_ejecucion('',$encuesta,$categoria,$desde,$hasta,$situacion);$i=1;
	if(is_array($result)){
