...
function detalle(codigo, responsable) {
    cerrar();
    //Realiza una peticion de contenido a la contenido.php
    $.post("../promts/risk/detalle.php", { codigo: codigo, responsable: responsable }, function (data) {
        // Ponemos la respuesta de nuestro script en el DIV recargado
        $("#Pcontainer").html(data);
    });
    abrirModal();
}
function detalle_oportunidad(codigo, responsable) {
    cerrar();
    //Realiza una peticion de contenido a la contenido.php
    $.post("../promts/risk/detalle_oportunidad.php", { codigo: codigo, responsable: responsable }, function (data) {
        // Ponemos la respuesta de nuestro script en el DIV recargado
        $("#Pcontainer").html(data);
    });
    abrirModal();
