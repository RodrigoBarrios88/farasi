...
function comprueba_extension(archivo, tipo) {
	...
	if (!archivo) {
		...
		switch (tipo) {
			// Imagenes
			case 1:
				if (".jpg" === extension || ".jpeg" === extension || ".png" === extension) return 1;
			// Documento
			case 2:
				if (".pdf" === extension) return 1;
		}
	}
	return 0;
}
