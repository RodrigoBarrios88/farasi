							...
							<div class="card-body all-icons">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<?php //echo utf8_decode(documento_html("documento", "", "select2")) ?>
										<input type="hidden" name="codigo" id="codigo" />
										<div class="col-md-6">
											<label>Seleccione Documento: </label> <span class="text-danger">*</span>
											<div class="input-group date">
												<a href="javascript:void(0)" onclick="documentos();" title="Seleccionar Documento" class="input-group-addon"><i class="fa fa-search"></i></a>
								...
								<div class="row">
									<div class="col-md-6">
										<label>Documento Soporte :</label> <span class="text-danger">*</span>
