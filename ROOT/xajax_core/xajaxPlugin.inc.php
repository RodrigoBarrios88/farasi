...
/*
	Class: xajaxPluginThe base class for all xajax plugins.
*/
class xajaxPlugin
{
}
...
/*
	Class: xajaxRequestPluginThe base class for all xajax request plugins.Request plugins handle the registration, client script generation and processing of
...
/*
	Class: xajaxResponsePluginBase class for all xajax response plugins.A response plugin provides additional services not already provided by the 
