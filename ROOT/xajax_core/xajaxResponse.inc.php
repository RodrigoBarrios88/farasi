...
/*
	...
	Contains the response class.Title: xajax response classPlease see <copyright.inc.php> for a detailed description, copyright
...
/*
	Class: xajaxResponseCollect commands to be sent back to the browser in response to a xajax
	...
	*/
	function wrapFunction($sFunction, $sArgs, $aScripts, $sReturnValueVariable)
	{
		...
		sFileName - (string):  The relative or fully qualified URI of the 
			javascript file.	sType - (string): Determines the script type . Defaults to 'text/javascript'. 	
		Returns:
	...
	*/
	function removeScript($sFileName, $sUnload = '') {
		...
		sFileName - (string):  The relative or fully qualified URI of
			the css file.	sMedia - (string): Determines the media type of the CSS file. Defaults to 'screen'. 
...
{
	var $sOutput;
	var $sContentType;var $sCharacterEncoding;
	var $bOutputEntities;
