/*
	File: xajax_debug.jsThis optional file contains the debugging module for use with xajax.  If
	...
	the processing of your xajax requests.Title: xajax debugging modulePlease see <copyright.inc.php> for a detailed description, copyright
...
{
	/*
		Class: xajax.debugThis object contains the variables and functions used to display process state
	...
	*/
	...
	/*
		...
		- <xjx.$>
		- <xjx.getFormValues>
		- <xjx.call>Must redefine these shortcuts as well:
		- <xajax.$>
		- <xajax.getFormValues>
	*/
	xjx = {}
