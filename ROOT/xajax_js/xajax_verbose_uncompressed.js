/*
	File: xajax_verbose.jsThe xajax verbose debugging module.  This is an optional module, include in
	your project with care. :)Title: xajax verbose debugging modulePlease see <copyright.inc.php> for a detailed description, copyright
	...
	*/		
	xajax.debug.verbose.makeFunction = function(obj, name) {
		return function() {
			...
			var msg = '--> ';
			msg += fun;	xajax.debug.writeMessage(msg);	var returnValue = true;
